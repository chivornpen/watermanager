...
<div class="row">
    <div class="col-lg-12">                
        <h1 class="page-header"><i class="fa fa-user"></i> Edit Staff</h1>
    </div>
               <!-- /.col-lg-12 -->
</div>
    <div class="row">
      <div class="col-lg-12">
        {!!Form::model($staff,['action'=>['StaffController@update',$staff->id],'method'=>'PATCH'])!!}
          {{csrf_field()}}
          <div class="row">
              <div class="col-lg-4">
              ...
              <div class="col-lg-3">
                   <div class="form-group {{ $errors->has('contactNo') ? ' has-error' : '' }}">
                    ...
                    {!!Form::text('contactNo',null,['class'=>'form-control','required'=>'true','placeholder'=>'provide phone number...'])!!}
              ...
              <div class="col-lg-3">
                   <div class="form-group {{ $errors->has('ssid') ? ' has-error' : '' }}">
                        ...
                        {!!Form::text('ssid',null,['class'=>'form-control','required'=>'true','placeholder'=>'provide SSID...'])!!}
                        @if ($errors->has('ssid'))
                            <span class="help-block">
